...
internal static class StructuredParsers
{
    ...
    public static int ConstructCheckpointLea(ParseContext ctx, JsonObject config, out object? pdata)
    {
    ...
    public static int ConstructJson(ParseContext ctx, JsonObject config, out object? pdata)
    {
        pdata = null;
    ...
    public static int ConstructNameValue(ParseContext ctx, JsonObject config, out object? pdata)
    {
        pdata = null;
