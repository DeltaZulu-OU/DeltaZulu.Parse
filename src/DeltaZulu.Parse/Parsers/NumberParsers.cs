...
{
    public static int ConstructFloat(ParseContext ctx, JsonObject config, out object? pdata)
    {
    ...
    public static int ConstructHexNumber(ParseContext ctx, JsonObject config, out object? pdata)
    {
    ...
    public static int ConstructNumber(ParseContext ctx, JsonObject config, out object? pdata)
    {
