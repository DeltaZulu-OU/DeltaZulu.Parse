...
{
    public static int Construct(ParseContext ctx, JsonObject config, out object? pdata)
    {
        pdata = null;
        Pdag? parser = null;
        Pdag? whileCond = null;
            ...
            out int parsed, bool wantValue, ref JsonNode? value)
    {
        ...
        do
        {
            ...
            var endNode = -1;
            r = PdagWalker.ParseRec(npb, data.ParserRoot, strtoffs, bPartialMatch: true,
            ...
            endNode = -1;
            r = PdagWalker.ParseRec(npb, data.WhileRoot, strtoffs, bPartialMatch: true,
    ...
    /// into the array.
    /// </summary>
    private static bool ChkNoDupeDotInParserDefs(ParseContext ctx, JsonNode? parsers)
    {
        var nParsers = 0;
        var nDots = 0;
