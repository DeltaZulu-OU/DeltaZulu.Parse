...
internal static class CoreParsers
{
    ...
    public static int ConstructCharSeparated(ParseContext ctx, JsonObject config, out object? pdata)
    {
        pdata = null;
    ...
    public static int ConstructCharTo(ParseContext ctx, JsonObject config, out object? pdata)
    {
        pdata = null;
        if (config["extradata"] is not JsonValue ed)
        {
    ...
    public static int ConstructOpQuotedString(ParseContext ctx, JsonObject config, out object? pdata)
    {
        pdata = null;
    ...
    public static int ConstructStringTo(ParseContext ctx, JsonObject config, out object? pdata)
    {
        pdata = null;
        if (config["extradata"] is not JsonValue ed)
        {
