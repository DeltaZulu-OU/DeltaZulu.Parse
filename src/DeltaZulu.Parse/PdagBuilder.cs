...
internal static class PdagBuilder
{
    ...
    /// </summary>
    public static int AddParser(ParseContext ctx, ref Pdag pdag, JsonNode prscnf)
    {
        Pdag? nextnode = null;
    ...
    /// </summary>
    public static int FindType(ParseContext ctx, string name, bool add)
    {
    ...
    /// </summary>
    public static ParserInstance? NewParser(ParseContext ctx, JsonObject prscnf)
    {
    ...
    /// </summary>
    private static int AddParserInstance(ParseContext ctx, JsonObject prscnf, Pdag pdag, ref Pdag? nextnode)
    {
    ...
    /// </summary>
    private static int AddParserInternal(ParseContext ctx, ref Pdag pdag, int mode, JsonNode prscnf, ref Pdag? nextnode)
    {
        int r;
    ...
    private static int AddParsers(ParseContext ctx, JsonArray prscnf, int mode, ref Pdag pdag, ref Pdag? pNextnode)
    {
        var dag = pdag;
